...
var optimist = require("optimist")
	...
	.boolean("history-api-fallback").describe("history-api-fallback", "Fallback to /test.html for Single Page Applications.")
...
new Server(webpack(wpOpt), options).listen(options.port, options.host, function(err) {
	...
	if(options.historyApiFallback)
		console.log("404s will fallback to %s", options.historyApiFallback.index || "/test.html");
});
